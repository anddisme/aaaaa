<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\2019phpstudy\PHPTutorial\WWW\xs/App/admin\view\email\index.html";i:1568079752;s:63:"E:\2019phpstudy\PHPTutorial\WWW\xs/App/admin\view\index\js.html";i:1568028337;s:65:"E:\2019phpstudy\PHPTutorial\WWW\xs/App/admin\view\index\foot.html";i:1510904601;}*/ ?>
﻿<!DOCTYPE html>
<html>
<head>
  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <li><a class="selected" href="<?php echo url('Email/index'); ?>">邮箱配置</a></li>
      </ul>
    </div>
  </div>
</div>
...
<dt>HOST服务器</dt>
<dd>
<input type="text" class="input normal" style="width:50%;"  id="host" name="host"  value="<?php echo $info['host']; ?>"  datatype="*1-50"  placeholder="请输入smtp服务器"/>
<span>*如：smtp.qq.com,smtp.126.com</span>
</dd>
</dl>
...
<dt>端口</dt>
<dd>
<input type="text" class="input normal" style="width:50%;"  id="port" name="port"  value="<?php echo $info['port']; ?>"  datatype="*1-50"  placeholder="请输入端口"/>
<span>*一般为465</span>
</dd>
</dl>
...
<dt>用户名</dt>
<dd>
<input type="text" class="input normal" style="width:50%;"  id="username" name="username"  value="<?php echo $info['username']; ?>"  datatype="*1-50"  placeholder="请输入用户名"/>
<span>*发送邮箱用户名</span>
</dd>
</dl>
...
<dt>密码</dt>
<dd>
<input type="password" class="input normal" style="width:50%;"  id="password" name="password"  value="<?php echo $info['password']; ?>"  datatype="*1-50"  placeholder="请输入密码"/>
<span>*发送邮箱密码</span>
</dd>
</dl>
...
<dt>默认主题</dt>
<dd>
<input type="text" class="input normal" style="width:50%;"  id="subject" name="subject"  value="<?php echo $info['subject']; ?>"  datatype="*1-50"  placeholder="请输入主题"/>
<span></span>
</dd>
</dl>
...
<dt>发送人邮箱</dt>
<dd>
<input type="text" class="input normal" style="width:50%;"  id="from" name="from"  value="<?php echo $info['from']; ?>"  datatype="*1-50"  placeholder="请输入发送人邮箱"/>
<span></span>
</dd>
</dl>
...
<dt>发送人昵称</dt>
<dd>
<input type="text" class="input normal" style="width:50%;"  id="fromname" name="fromname"  value="<?php echo $info['fromname']; ?>"  datatype="*1-50"  placeholder="请输入发送人昵称"/>
<span></span>
</dd>
</dl>
