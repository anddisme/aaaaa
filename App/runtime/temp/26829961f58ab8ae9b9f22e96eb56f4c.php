<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"E:\2019phpstudy\PHPTutorial\WWW\xs/App/admin\view\ad\index.html";i:1568106378;s:63:"E:\2019phpstudy\PHPTutorial\WWW\xs/App/admin\view\index\js.html";i:1568028337;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
function tos()
{
  ...
  window.location='<?php echo url("Ad/index"); ?>?kw='+$("#kw").val();
}
</script>
...
<ul class="icon-list">
  <li><a class="add" onClick="return typeidisnull()" href="<?php echo url('Ad/add'); ?>"><i></i><span>新增广告</span></a></li>
</ul>
</div>
</div>
</div>
...
<td align="center">
<span class="checkall">
<input type="checkbox" id="IDList" name="IDList" style="border:n0" value="<?php echo $links['id']; ?>" /> 
</span>
<?php echo $news['id']; ?>

</td>
<td>
<?php echo $links['Title']; if($links['S_Image'] != ''): ?><font  style="color:red" class="picshow" rel="<?php echo $links['S_Image']; ?>">[图]</font><?php endif; ?>
</td>

<td align="center" fd="links"><?php echo $links['links']; ?></td>
<td align="center"><?php echo $links['enduptime']; ?></td>
<td align="center">
<a href="<?php echo url('Ad/updata',array('id'=>$links['id'])); ?>">修改</a> <a onClick="return delid('<?php echo $links[id]; ?>','ad')" href="javascript:;">删除</a>
</td>
</tr>
...
全选</label>
<button class="btn btn-primary" onClick="return myAction('DelSome')">&nbsp;选中删除&nbsp;</button>
</ul>
</div>
</div>
</div>
