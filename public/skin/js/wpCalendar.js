...
function wpCalendar(){
	...
	this.datestyle	= "yyyy-MM-dd 00:00:00";		//added in Ver 2.1
...
function CalendarTheme(){
	...
	this.buttonBorderColor	= "#ccc";	//按钮边框颜色
...
var theme=new Object();
	...
	theme["Classic"].versioninfo		= "主题：Classic 作者：dengwubin";	//主题的版本信息
	theme["Classic"].fontFamily			= "宋体";		//字体
	theme["Classic"].borderColor		= "#EEF8ED";	//边框颜色
	...
	theme["Classic"].mouseOverColor		= "#ccc";	//鼠标移动的背景色
	theme["Classic"].mouseOverFontColor = "#000000";	//鼠标移动的字体颜色
	theme["Classic"].buttonBorderColor	= "#EEF8ED";	//按钮边框颜色
	...
	theme["Classic"].dragBarColor		= "#EEF8ED";	//拖动条的边框颜色
